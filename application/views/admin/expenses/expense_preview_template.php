    ...
    <div class="panel_s">
        <div class="panel-body">
            ...
            <div class="row mtop20">
                ...
                <div class="mb-8">
                    <?php
                    if (has_access(get_staff_user_id(), $expense->department, $get_setting)) {

                        if (has_permission('purchase_order_change_approve_status', '', 'edit')) {
                    ?>
                            <select name="status" id="status" class="selectpicker pull-right mright10" onchange="change_status_expenses(this,<?php echo ($expense->id); ?>); return false;" data-live-search="true" data-width="35%" data-none-selected-text="<?php echo _l('pur_change_status_to'); ?>">
                                <option value=""></option>
                                <option value="1" class="<?php if ($expense->approve_status == 1) {
                                                                echo 'hide';
                                                            } ?>"><?php echo _l('purchase_draft'); ?></option>
                                <option value="2" class="<?php if ($expense->approve_status == 2) {
                                                                echo 'hide';
                                                            } ?>"><?php echo _l('purchase_approved'); ?></option>
                                <option value="0" class="<?php if ($expense->approve_status == 3) {
                                                                echo 'hide';
                                                            } ?>"><?php echo _l('pur_rejected'); ?></option>
                                <option value="4" class="<?php if ($expense->approve_status == 4) {
                                                                echo 'hide';
...
<script>
    ...
    function change_status_expenses(invoker, id) {
        "use strict";
