...
<div class="row">
   ...
   <?php echo form_open($this->uri->uri_string(), array('class' => 'vendor-form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data')); ?>
         ...
         <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     <label for="npwp"
                        class="npwp">NPWP</label>
                     <input type="file" name="npwp" class="form-control" id="npwp">
                     <?php
                     if (isset($client)) {
                        if ($client->npwp != "") {
                           echo '<br><img src="/uploads/vendor/' . $client->npwp . '" alt="NPWP" width="150px"/>';
                        }
                     }
                     ?>
