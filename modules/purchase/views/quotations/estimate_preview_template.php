...
<div class="col-md-12 no-padding">
   <div class="panel_s">
      <div class="panel-body">
         ...
         <div class="row">
            <div class="col-md-4">
               <p class="bold mtop15"><?php echo _l('clients') . ': ' ?><a href="<?php echo admin_url('clients/client/' . $estimate->clientid); ?>"><?php echo pur_html_entity_decode($estimate->client->company); ?></a></p>
            </div>
            <div class="col-md-8">
                        ...
                        <?php if ($estimate->project_id != 0) { ?>
                           <div class="col-md-12">
                              <h4 class="font-medium mbot15"><?php echo _l('related_to_pur_request', array(
                                                                  ...
                                                                  _l('project'),
                                                                  '<a href="' . admin_url('projects/view/' . $estimate->project_data->id) . '" target="_blank">' . $estimate->project_data->name . '</a>',
                                                               )); ?></h4>
                           </div>
                        <?php } ?>
                     <?php } ?>
